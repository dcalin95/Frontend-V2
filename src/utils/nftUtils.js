...
export const getMindNFTContract = async () => {
  try {
    ...
    console.error('❌ Failed to get NFT contract:', error);
    throw error;
  }
};
...
export const mintMindNFT = async (recipientAddress, imageDataUrl, nftData) => {
  try {
    console.log('🔨 Starting Mind NFT minting process...');
    ...
    console.log('✅ Mind NFT minted successfully!');
...
export const transferMindNFT = async (fromAddress, toAddress, tokenId) => {
  try {
    ...
    console.log('⏳ Transfer transaction sent, waiting for confirmation...', tx.hash);
    const receipt = await tx.wait();

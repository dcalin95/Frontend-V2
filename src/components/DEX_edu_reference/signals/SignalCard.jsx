...
import { formatCurrency, formatPercentage, formatRelativeTime } from '../utils/DEX/formatters';
import LoadingSpinner from '../common/LoadingSpinner';
import '../../../styles/DEX/components/signal-card.css';
    ...
    >
      ...
      <div className="signal-card-content">
        ...
        {confidencePercent !== null && (
          <div className="signal-card-confidence" title="Heuristic decision score; not a calibrated probability.">
            <span className="signal-card-confidence-label">Decision score:</span>

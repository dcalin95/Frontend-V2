...
export const fetchSkyControlCentralAdminOverview = (options) => fetchSkyControl('/central-admin/overview', options);
export const fetchSkyControlCentralAdminUsers = (options) => fetchSkyControl('/central-admin/users', options);
export const fetchSkyControlCentralAdminUser = (userId, options) => fetchSkyControl(`/central-admin/users/${encodeURIComponent(userId)}`, options);

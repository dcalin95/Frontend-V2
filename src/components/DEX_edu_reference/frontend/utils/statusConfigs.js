...
/**
 * Get decision score level configuration (heuristic; not a calibrated probability).
 * @param {number} confidence - Heuristic decision score 0-1 from OTA/LLM
 * @returns {Object} Level configuration for display
 */

...
export default function Login() {
  ...
  const { user: existing, loading: authLoading, signOut: contextSignOut } = useAuth();
  ...
  async function onSubmit(e) {
    ...
    try {
      await signInWithEmail(email, username);
      navigate('/presale');
    } catch (err) {
      ...
      <div className="login-page">
        <div className="login-card profile-card">
          ...
          <div className="existing-actions">
            <button className="btn primary" onClick={() => navigate('/presale')}>
    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div className="providers">
          ...
          <button className="btn provider provider-google" onClick={()=>onProvider('google')}>

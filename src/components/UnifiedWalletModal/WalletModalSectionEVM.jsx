/**
 * EVM section of UnifiedWalletModal: UI-only list of EVM wallets.
 * Uses real logos (Trust Wallet, MetaMask, etc.) when available, with emoji fallback.
 */
  ...
  return (
    <div className="wallet-section">
      <h3 className="wallet-section-title">
        <img src={evmIcon} alt="EVM" style={{ width: 16, height: 16, marginRight: 6, flexShrink: 0, objectFit: 'contain', verticalAlign: 'middle', display: 'inline-block' }} />

...
export const SOLANA_CONFIG = {
  // RPC endpoints (default: devnet)
  rpcHttp: process.env.REACT_APP_SOL_RPC_HTTP || "https://api.devnet.solana.com",
  rpcWs: process.env.REACT_APP_SOL_RPC_WS || "wss://api.devnet.solana.com",
  ...
  destinationWallet:
    ...
    // fallback (current hardcoded address used before centralization)
